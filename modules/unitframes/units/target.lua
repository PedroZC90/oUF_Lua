...
-- oUF Target:
------------------------------------------------------------
T.TargetStyle = function(self, unit)
	...
	self:Tag(Name, "[oUF_Lua:namecolor][oUF_Lua:namelong] [oUF_Lua:diffcolor][level] [shortclassification]")
	...
	if C.unitframes.altpower then
		...
		AltPower:SetPoint("BOTTOMLEFT", Health, "TOPLEFT", 0, 7)
		AltPower:SetPoint("BOTTOMRIGHT", Health, "TOPRIGHT", 0, 7)
		...
		AltPower.Info:SetPoint("CENTER", AltPower, "CENTER", 0, 1)
		AltPower.Info:SetJustifyH("CENTER")
	...
	if C.unitframes.targetauras then
		...
		Buffs:SetPoint("BOTTOMLEFT", Health, "TOPLEFT", 0, 7 + yOffset)
		...
		Debuffs:SetPoint("BOTTOMRIGHT", Buffs, "TOPRIGHT", 0, 7)
