...
if not C.unitframes.raiddebuffwatch then return end

------------------------------------------------------------
-- oUF_AuraWatch Filter
------------------------------------------------------------
T.AuraWatchBuffs = {
	["PRIEST"] = {
		{ 41635, "BOTTOMRIGHT", { .20, .70, .20 } },		-- Prayer of Mending
		{ 139, "BOTTOMLEFT", { .40, .70, .20 } },			-- Renew
		{ 17, "TOPLEFT", { .81, .85, .10 }, true },			-- Power Word: Shield
	},
	["DRUID"] = {
		{ 774, "TOPLEFT", { .80, .40, .80 } },				-- Rejuvenation
		{ 155777, "LEFT", { .80, .40, .80 } },				-- Germination
		{ 8936, "TOPRIGHT", { .20, .80, .20 } },			-- Regrowth
		{ 33763, "BOTTOMLEFT", { .40, .80, .20 } },			-- Lifebloom
		{ 48438, "BOTTOMRIGHT", { .80, .40, .00 } },		-- Wild Growth
	},
	["PALADIN"] = {
		{ 53563, "TOPLEFT", { .70, .30, .70 } },			-- Beacon of Light
		{ 156910, "TOPRIGHT", { .70, .30, .70 } },			-- Beacon of Faith
		{ 1022, "BOTTOMRIGHT", { .20, .20, 1.0 }, true },	-- Hand of Protection
		{ 1044, "BOTTOMRIGHT", { .89, .45, .00 }, true },	-- Hand of Freedom
		{ 6940, "BOTTOMRIGHT", { .89, .10, .10 }, true },	-- Hand of Sacrifice
		{ 114163, "BOTTOMLEFT", { .81, .85, .10 }, true },	-- Eternal Flame
	},
	["SHAMAN"] = {
		{ 61295, "TOPLEFT", { .70, .30, .70 } },			-- Riptide
	},
	["MONK"] = {
		{ 119611, "TOPLEFT", { .80, .40, .80 } },			-- Renewing Mist
		{ 116849, "TOPRIGHT", { .20, .80, .20 } },			-- Life Cocoon
		{ 124682, "BOTTOMLEFT", { .40, .80, .20 } },		-- Enveloping Mist
		{ 124081, "BOTTOMRIGHT", { .70, .40, .00 } },		-- Zen Sphere
	},
	["ALL"] = {
		{ 14253, "RIGHT", { .00, 1.0, .00 } },				-- Abolish Poison
	},
}

------------------------------------------------------------
-- oUF_RaidDebuffs Filter
------------------------------------------------------------
T.RaidDebuffsTracking = {
	
	[GetSpellInfo(163771)] = 6,	-- Dreadful Roar (Grimfrost Wolfslayer - Frostfire Ridge)
